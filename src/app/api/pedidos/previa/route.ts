...
// Corpo: { dados: PedidoInput, numero?: number, createdAt?: string } —
// numero/createdAt vêm só na edição de um orçamento já salvo.
export async function POST(req: Request) {
  ...
  const pdfBuffer = await gerarPdfOrcamento(pedido, { previa: true });
